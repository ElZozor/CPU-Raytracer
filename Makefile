...
CC=g++
CFLAGS=-Wall -std=c++17 -g -I./glm-master/ -fopenmp -I./lodepng-master/ -march=native -O3
SRCS=main.cpp image.cpp raytracer.cpp scene.cpp kdtree.cpp ./lodepng-master/lodepng.cpp unit-test.cpp ObjLoader.cpp
...
mrt: main.o image.o scene.o raytracer.o kdtree.o ./lodepng-master/lodepng.o ObjLoader.o
	$(CC) $(CFLAGS) $^ -o $@
